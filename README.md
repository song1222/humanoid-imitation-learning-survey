...
Data source, simulator, robot platform, project links, and code links are kept as metadata in `data/papers.json`, but the README classification follows only the method categories used in the paper.
